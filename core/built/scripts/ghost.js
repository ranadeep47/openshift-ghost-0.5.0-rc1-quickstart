...
define("ghost/controllers/settings/users/user", 
  ["ghost/models/slug-generator","ghost/utils/bound-one-way","exports"],
  function(__dependency1__, __dependency2__, __exports__) {
    "use strict";
...
function program11(depth0,data) {
  ...
  data.buffer.push(" data-off-canvas=\"left\">\n        <span class=\"hidden\">Ghost</span>\n    </a>\n    <nav id=\"global-nav\" role=\"navigation\">\n        <ul id=\"main-menu\" >\n            ");
  data.buffer.push(escapeExpression((helper = helpers['gh-activating-list-item'] || (depth0 && depth0['gh-activating-list-item']),options={hash:{
    'route': ("posts"),
    'title': ("Content"),
  ...
  stack1 = (helper = helpers['gh-popover-button'] || (depth0 && depth0['gh-popover-button']),options={hash:{
    ...
    'href': ("#"),
    'classNames': ("dropdown")
  },hashTypes:{'popoverName': "STRING",'tagName': "STRING",'href': "STRING",'classNames': "STRING"},hashContexts:{'popoverName': depth0,'tagName': depth0,'href': depth0,'classNames': depth0},inverse:self.noop,fn:self.program(3, program3, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "gh-popover-button", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n                ");
  stack1 = (helper = helpers['gh-popover'] || (depth0 && depth0['gh-popover']),options={hash:{
    'tagName': ("ul"),
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push(escapeExpression((helper = helpers['gh-trim-focus-input'] || (depth0 && depth0['gh-trim-focus-input']),options={hash:{
    ...
    'value': ("titleScratch"),
    'tabindex': ("1")
  },hashTypes:{'type': "STRING",'id': "STRING",'placeholder': "STRING",'value': "ID",'tabindex': "STRING"},hashContexts:{'type': depth0,'id': depth0,'placeholder': depth0,'value': depth0,'tabindex': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "gh-trim-focus-input", options))));
...
function program1(depth0,data) {
  ...
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    ...
    'autocorrect': ("off"),
    'value': ("email")
  },hashTypes:{'class': "STRING",'id': "STRING",'type': "STRING",'placeholder': "STRING",'name': "STRING",'autofocus': "STRING",'autocapitalize': "STRING",'autocorrect': "STRING",'value': "ID"},hashContexts:{'class': depth0,'id': depth0,'type': depth0,'placeholder': depth0,'name': depth0,'autofocus': depth0,'autocapitalize': depth0,'autocorrect': depth0,'value': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "input", options))));
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push(escapeExpression((helper = helpers['gh-blur-input'] || (depth0 && depth0['gh-blur-input']),options={hash:{
    ...
    'selectOnClick': ("true")
  },hashTypes:{'class': "STRING",'id': "STRING",'value': "ID",'name': "STRING",'action': "STRING",'placeholder': "ID",'selectOnClick': "STRING"},hashContexts:{'class': depth0,'id': depth0,'value': depth0,'name': depth0,'action': depth0,'placeholder': depth0,'selectOnClick': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "gh-blur-input", options))));
  ...
  },hashTypes:{'class': "STRING",'value': "ID",'name': "STRING",'action': "STRING",'placeholder': "ID"},hashContexts:{'class': depth0,'value': depth0,'name': depth0,'action': depth0,'placeholder': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "gh-blur-input", options))));
...
function program1(depth0,data) {
  ...
  data.buffer.push("\n\n                ");
  stack1 = helpers['if'].call(depth0, "showApps", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(4, program4, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n            ");
  return buffer;
  }
...
function program4(depth0,data) {
  ...
  var buffer = '', stack1;
  data.buffer.push("\n                    ");
  stack1 = helpers.unless.call(depth0, "session.user.isEditor", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(5, program5, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n                ");
  return buffer;
  }
...
function program13(depth0,data) {
  ...
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "openModal", "invite-new-user", "", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0,depth0,depth0],types:["STRING","STRING","ID"],data:data})));
...
function program6(depth0,data) {
  ...
  stack1 = (helper = helpers['gh-popover-button'] || (depth0 && depth0['gh-popover-button']),options={hash:{
    ...
    'title': ("User Actions")
  },hashTypes:{'popoverName': "STRING",'tagName': "STRING",'classNames': "STRING",'title': "STRING"},hashContexts:{'popoverName': depth0,'tagName': depth0,'classNames': depth0,'title': depth0},inverse:self.noop,fn:self.program(7, program7, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "gh-popover-button", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n                ");
  stack1 = (helper = helpers['gh-popover'] || (depth0 && depth0['gh-popover']),options={hash:{
...
function program9(depth0,data) {
  ...
  var buffer = '', helper, options;
  data.buffer.push("\n                    ");
  data.buffer.push(escapeExpression((helper = helpers.render || (depth0 && depth0.render),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "user-actions-menu", options) : helperMissing.call(depth0, "render", "user-actions-menu", options))));
  data.buffer.push("\n                ");
  return buffer;
  }
...
function program11(depth0,data) {
  ...
  data.buffer.push("<header class=\"user-settings-header\">\n\n    <h2 class=\"hidden\">Your Profile</h2>\n\n    <div class=\"settings-header-inner\">\n        ");
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{
    'class': ("button-back button")
  },hashTypes:{'class': "STRING"},hashContexts:{'class': depth0},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "settings", options) : helperMissing.call(depth0, "link-to", "settings", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program3(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, "view.parentView.rolesDropdownIsVisible", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n");
